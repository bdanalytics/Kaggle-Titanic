...
title: "Titanic: Survived classification:: Titanic_Age"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://www.kaggle.com/c/titanic/download/train.csv  
...
setwd("~/Documents/Work/DataScience/Kaggle/Titanic")
...
glbFeatsCategory <- "Sex.fctr" # choose from c(NULL : default, "<category_feat>")
...
#   Feature-engineering phase -> start by excluding all features except id & category & work each one in
    ...
    ,"Name"         # 1,307 unique strings # Derived Name.last.1
    #,"Sex","Age"
...
#data.frame(ImageId = mapfn(glbObsAll$.src, glbObsAll$.pos))[7045:7055, ]
    ...
    # character
require(stringr)
glbFeatsDerive[["Name.last.1"]] <- list(
...
glbFeatsDerive[["Pclass.fctr"]] <- list(
  ...
  , args = c("Pclass"))
# glbFeatsDerive[["Age.fctr"]] <- list(
#     mapfn = function(Age) { return(cut(sapply(Age, 
#                         function(thsAge) { if (is.na(thsAge)) return(-1) else return(thsAge) }), 
#                                         breaks = c(-2, 0, 10, 20, 30, 40, 50, 90),
#                                         ordered_result = TRUE)) } 
#   , args = c("Age"))
...
glbFctrMaxUniqVals <- 27 # default: 20
